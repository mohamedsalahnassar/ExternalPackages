...
let package = Package(
    ...
    dependencies: [
        .package(path: "../Vendor/abseil-cpp-swiftpm"),
        ...
        .package(path: "../Vendor/boringssl-swiftpm"),
        .package(path: "../Vendor/collectionconcurrencykit"),
        ...
        .package(path: "../Vendor/googleappmeasurement"),
        .package(path: "../Vendor/GoogleDataTransport"),
        .package(path: "../Vendor/GoogleMaps"),
        .package(path: "../Vendor/GooglePlaces"),
        .package(path: "../Vendor/googleutilities"),
        .package(path: "../Vendor/grpc-swiftpm"),
        .package(path: "../Vendor/gtm-session-fetcher"),
        ...
        .package(path: "../Vendor/sourcekitten"),
