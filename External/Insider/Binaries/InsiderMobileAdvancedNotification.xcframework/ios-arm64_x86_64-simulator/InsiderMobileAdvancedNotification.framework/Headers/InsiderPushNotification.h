...
+(void)showInsiderRichPush:(UNMutableNotificationContent *)bestAttemptContent appGroup:(NSString *)appGroup nextButtonText:(NSString *)nextButtonText goToAppText:(NSString *)goToAppText success:(void (^)(UNNotificationAttachment* attachment))completionBlock;
+(void)serviceExtensionTimeWillExpire:(UNNotificationRequest *)request content:(UNMutableNotificationContent *)bestAttemptContent;
