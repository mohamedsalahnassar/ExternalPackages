...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("JumioLiveness", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace JumioLiveness SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("JumioLiveness") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN void * _Nonnull $s13JumioLivenessAACABycfC(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init()
SWIFT_EXTERN void $s13JumioLivenessAAC5resetyyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // reset()
SWIFT_EXTERN void $s13JumioLivenessAAC5resetyyFTj(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for reset()
SWIFT_EXTERN void $s13JumioLivenessAAC5cleanyyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // clean()
SWIFT_EXTERN void $s13JumioLivenessAAC5cleanyyFTj(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for clean()
...
class SWIFT_SYMBOL("s:13JumioLivenessAAC") JumioLiveness;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<JumioLiveness::JumioLiveness> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_JumioLiveness;
// Type metadata accessor for JumioLiveness
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s13JumioLivenessAACMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:13JumioLivenessAAC") JumioLiveness : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK JumioLiveness init() SWIFT_SYMBOL("s:13JumioLivenessAACABycfc");
  SWIFT_INLINE_THUNK void reset() SWIFT_SYMBOL("s:13JumioLivenessAAC5resetyyF");
  SWIFT_INLINE_THUNK void clean() SWIFT_SYMBOL("s:13JumioLivenessAAC5cleanyyF");
protected:
  SWIFT_INLINE_THUNK JumioLiveness(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_JumioLiveness;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s13JumioLivenessAACD;
  static inline constexpr $s13JumioLivenessAACD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_JumioLiveness {
public:
static SWIFT_INLINE_THUNK JumioLiveness makeRetained(void * _Nonnull ptr) noexcept { return JumioLiveness(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<JumioLiveness::JumioLiveness> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return JumioLiveness::_impl::$s13JumioLivenessAACMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<JumioLiveness::JumioLiveness> { using type = JumioLiveness::_impl::_impl_JumioLiveness; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace JumioLiveness SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("JumioLiveness") {
  ...
  SWIFT_INLINE_THUNK JumioLiveness JumioLiveness::init() {
  return _impl::_impl_JumioLiveness::makeRetained(_impl::$s13JumioLivenessAACABycfC(swift::TypeMetadataTrait<JumioLiveness>::getTypeMetadata()));
  }
  SWIFT_INLINE_THUNK void JumioLiveness::reset() {
  return _impl::$s13JumioLivenessAAC5resetyyFTj(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void JumioLiveness::clean() {
  return _impl::$s13JumioLivenessAAC5cleanyyFTj(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }

} // namespace JumioLiveness
