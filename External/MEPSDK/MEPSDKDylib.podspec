#
#  Be sure to run `pod spec lint MEPSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://maven.moxtra.com/repo/mepsdkdylib.git", :tag => "#{s.version}" }
  ...
  # s.resource  = "icon.png"
  # s.resources = "Common/MEPSDK.framework"
